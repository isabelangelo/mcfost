"""
This code defines two classes, Model and Obs for handling model SED's from MCFOST
as well as observed SEDs. Each class contains the SEDs, their wavelengths, and methods
