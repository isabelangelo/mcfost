...
combinations = [(a,b,c,d,e,f,g,h) for a in dust_mass for b in Rc for c in f_exp \
for d in H0 for e in Rin for f in sd_exp for g in porosity for h in amax]
...
#     new_para.zones[0].dust[0].amax = comb[7]
